...
contract MyCopilotBae is ERC20, Ownable {
    ...
    constructor() ERC20("My Copilot Bae", "Bae") {
    ...
    function changeFees(uint256 _buyFee, uint256 _sellFee) public onlyOwner {
        require(_buyFee <= 20, "fee too high");
        require(_sellFee <= 20, "fee too high");
        buyFeeRate = _buyFee;
        sellFeeRate = _sellFee;
    }
}
